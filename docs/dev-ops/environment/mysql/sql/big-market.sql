...
VALUES (1, 100001, 101, '随机积分', NULL, 80000, 80000, 80.0000, 'rule_random,rule_luck_award', 1,
       ...
       (10, 100002, 101, '随机积分', NULL, 1, 1, 80.0000, 'rule_random,rule_luck_award', 1, '2023-12-09 09:38:31',
        '2023-12-09 10:58:06'),
       (11, 100002, 102, '5次使用', NULL, 1, 1, 19.0000, 'rule_luck_award', 2, '2023-12-09 09:39:18',
        '2023-12-09 10:34:23'),
       (12, 100002, 103, '10次使用', NULL, 1, 1, 1.0000, 'rule_luck_award', 3, '2023-12-09 09:42:36',
        '2023-12-09 10:34:24');

INSERT INTO `strategy_award` (`id`, `strategy_id`, `award_id`, `award_title`, `award_subtitle`, `award_count`,
                              `award_count_surplus`, `award_rate`, `rule_models`, `sort`, `create_time`, `update_time`)
VALUES (13,100003,107,'增加dall-e-3画图模型','抽奖1次后解锁',200,200,0.0400,'rule_lock,rule_luck_award',7,'2023-12-09 09:45:38','2023-12-23 14:01:02'),
